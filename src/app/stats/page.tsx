...
export default function StatsPage() {
  ...
  const structuredData = {
    ...
    "description": "Statistics and analytics for Golden Chocobo card discoveries, including average prices, highest sales, and discovery trends",
    "url": "https://goldenchocobotracker.com/stats",
    "mainEntity": {
      "@type": "Dataset",
      "name": "Golden Chocobo Card Statistics",
      "description": "Comprehensive statistics for 77 serialized Golden Chocobo cards from MTG Final Fantasy",
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Statistics and analytics for Golden Chocobo card discoveries, including average prices, highest sales, and discovery trends." />
        <script
